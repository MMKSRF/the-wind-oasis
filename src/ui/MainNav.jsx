...
import {HiOutlineCalculator, HiOutlineHome, HiOutlineUsers} from "react-icons/hi";
    ...
    return (
        <nav>
            <NavList>
                ...
                <li><StyledNavLink to='/bookings'> <HiOutlineCalculator/> <span>Bookings</span> </StyledNavLink></li>
